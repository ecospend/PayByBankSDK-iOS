...
public struct PaymentOption: Codable {
    ...
    /// If provided, our system automatically converts the payment into a Scheduled Payment in [ISO 8601](https://en.wikipedia.org/wiki/ISO_8601) format with [time zone designator](https://en.wikipedia.org/wiki/ISO_8601#Time_zone_designators).
